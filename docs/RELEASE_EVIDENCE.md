...
- The reviewed local artifact remains excluded from Git. Earlier uploads have been retired and are not part of the current release.

## Public calm-Aiden replacement

- The replacement is 165.000 seconds, 1920×1080 at 30 fps, with H.264 video, mono 48 kHz AAC narration, and an embedded English subtitle stream. Its SHA-256 is `536b0ae74d59e836313044a94237a6ec988e4b4b315dccc1e017269c3baa8de9`.
...
- Full decoding passed. Privacy review covered representative frames, OCR, metadata, binary strings, audio, and subtitles and found no credentials, email, private filesystem path, or personal phone number.
...
- The replacement is public at `https://youtu.be/UIl6YiQPIWc`; YouTube reported no copyright-check issue. Devpost embeds this reviewed current video.
...
- Public demonstration video: `https://youtu.be/UIl6YiQPIWc`; YouTube reports a 2:45 duration and no copyright-check issues. Earlier uploads are retired.
