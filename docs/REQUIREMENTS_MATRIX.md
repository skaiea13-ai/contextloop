...
| Public demonstration video under three minutes | Published 155-second final cut from the real OAuth run: `https://youtu.be/VW5ZLLwqPoQ` | Complete and publicly reachable |
